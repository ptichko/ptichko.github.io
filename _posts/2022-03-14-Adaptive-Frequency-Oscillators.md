...
The Hopf oscillator is a non-linear oscillator that spontaneously oscillates, i.e., spontaneously enters a limit cycle. The equations of motion for the Hopf oscillator are given by the following systems of ODEs, here represented in Cartesian coordinates:
