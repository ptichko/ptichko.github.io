...
where y-prime is the predicted number of citations since the career start, the year 1982 in this example, and alpha and beta are parameters to be estimated.
